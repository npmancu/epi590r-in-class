...
hispanic_male_perc <- inline_text(table1, variable = "race_eth_cat", 
                             ...
                             column = "Male", 
                             pattern = "{p}%")
black_female_perc <- inline_text(table1, variable = "race_eth_cat", 
                             level="Black",
                             column = "Female", 
                             pattern = "{p}%")
...
@tbl-one contains descriptive statistics from our study sample. In our sample, `r hispanic_male_perc` of male participants were of Hispanic ethnicity and `r black_female_perc` of female participants were Black.
